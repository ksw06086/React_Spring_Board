...
export default function Main() {
  ...
  const MainTop = () => {
    ...
    const getTop3BaordListResponse = (responseBody: GetTop3BoardListResponseDto | ResponseDto | null) => {
    ...
    useEffect(() => {
      getTop3BoardListRequest().then(getTop3BaordListResponse);
    }, []);
    ...
    return (
      <div id='main-top-wrapper'>
        <div className='main-top-container'>
          <div className='main-top-title'>{'Normal Board에서\n다양한 이야기를 나눠보세요'}</div>
